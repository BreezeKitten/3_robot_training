...
resTH = PI/15
LOG_DIR = 'logs/Residual_Learning_midLayer/20200103'
...
training_num = 3000
test_num = 1
Network_Path = '2_to_3_robot_network/Residual_network_midLayer/20200103'
...
if __name__ == '__main__':
    ...
    NOW = datetime.datetime.now().strftime('%Y%m%d-%H%M%S') + '_Residual_midLayer_init'
    ...
    with tf.name_scope('2_robot_NW_12'):
        ...
        value_12, Wf_12, Bf_12 = add_layer(H4_12, layer4_output_number, 1, 'Wf', 'Bf', activation_function=tf.nn.sigmoid)
    ...
    with tf.name_scope('2_robot_NW_13'):
        ...
        value_13, Wf_13, Bf_13 = add_layer(H4_13, layer4_output_number, 1, 'Wf', 'Bf', activation_function=tf.nn.sigmoid)
    ...
    two_network_saver_12.restore(sess,'2_robot_network/200_150_100_50/20200103/test.ckpt')
    two_network_saver_13.restore(sess,'2_robot_network/200_150_100_50/20200103/test.ckpt')
    ...
    for i in range(1):
        ...
        NOW = datetime.datetime.now().strftime('%Y%m%d-%H%M%S') + '_Residual_midLayer'
        FM = file_manger.file_manger(LOG_DIR,NOW)
        SAVE_DIR = FM.log_path
        FM.create_dir()    
